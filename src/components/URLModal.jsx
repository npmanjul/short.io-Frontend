                ...
                visitAnalytics.visitCounts.length > 0 ? (
                    ...
                    <div className="w-full flex justify-center items-center gap-4 flex-col p-4 bg-gray-100 rounded-xl">
                      ...
                      <div className="flex justify-center items-center w-full gap-4 flex-col sm:flex-row">
                        <div className="flex justify-center items-center w-full flex-col gap-4 bg-white rounded-xl py-4">
                          ...
                          <DoughnutChart
                            labelsArray={deviceInfoAnalytics.deviceTypes || []}
                            dataArray={
                        ...
                        <div className="flex justify-center items-center w-full flex-col py-4 gap-4 bg-white rounded-xl">
                          ...
                          <DoughnutChart
                            ...
                            dataArray={deviceInfoAnalytics.languageCounts || []}
                            labelName={"Location"}
                            title={"Location"}
                            tooltipName={"Visit"}
                            bgColorArray={generateRandomColors(
                      ...
                      <div className="flex justify-center items-center w-full gap-4 flex-col sm:flex-row">
                        ...
                        <div className="flex justify-center items-center w-full flex-col py-4 gap-4 bg-white rounded-xl">
                          ...
                          <DoughnutChart
                            ...
                            dataArray={deviceInfoAnalytics.platformCounts || []}
                            labelName={"Location"}
                            title={"Location"}
                            tooltipName={"Visit"}
                            bgColorArray={generateRandomColors(
                      ...
                      <div className="flex justify-center items-center w-full flex-col gap-4 bg-white rounded-xl py-4">
                        ...
                        <div className="w-full flex justify-center items-center h-[300px] py-3">
                          <BarChart
                            labelsArray={deviceInfoAnalytics.deviceCores || []}
                            dataArray={
                      ...
                      <div className="flex justify-center items-center w-full gap-4 flex-col sm:flex-row">
                        ...
                        <div className="flex justify-center items-center w-full flex-col py-4 gap-4 bg-white rounded-xl">
                          ...
                          <DoughnutChart
                            ...
                            dataArray={networkInfoAnalytics.hostingCounts || []}
                            labelName={"Location"}
                            title={"Location"}
                            tooltipName={"Visit"}
                            bgColorArray={generateRandomColors(
                      ...
                      <div className="flex justify-center items-center w-full flex-col gap-4 bg-white rounded-xl py-4">
                        ...
                        <div className="w-full flex justify-center items-center h-[300px] py-3">
                          <BarChart
                            ...
                            chartTitle={"Users"}
                            bgColorArray={generateRandomColors(
                              batteryInfoAnalytics.chargingStatuses?.length || 0
                            )}
                          />
                        </div>
                      </div>
                  ...
                  <div className="flex flex-col items-center justify-center w-full py-12 px-4">
                    ...
                    <p className="text-gray-500 dark:text-gray-400 text-center max-w-sm">
                      ...
                      appear here once people start visiting your shortened URL.
                    </p>
                  </div>
                )}
              </div>
