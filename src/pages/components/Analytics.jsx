      ...
      <div className="flex justify-center items-center flex-col gap-5 w-full">
        ...
        <div className="flex justify-center items-center flex-wrap w-full gap-5 bg-gray-50 p-5 rounded-lg">
          ...
          <div className="flex justify-center items-center w-full gap-5">
            ...
            <div className="bg-white rounded-lg p-4 w-full">
              <h3 className="text-sm font-medium text-gray-600 mb-2">City</h3>
            ...
            {/* Device Distribution Chart */}
            <div className="bg-white rounded-lg p-4 w-full">
              <h3 className="text-sm font-medium text-gray-600 mb-2">State</h3>
              <div className="h-[300px] flex justify-center items-center">
                <PieChart
        ...
        <div className="flex justify-center items-center flex-wrap w-full gap-5 bg-gray-50 p-5 rounded-lg">
          ...
          <div className="flex justify-center items-center w-full gap-5 ">
            {/* vender Chart */}
            <div className="bg-white rounded-lg p-4 w-full">
              <h3 className="text-sm font-medium text-gray-600 mb-2">Vendor</h3>
              <div className="h-[300px] flex justify-center items-center">
                <DoughnutChart
        ...
        <div className="flex justify-center items-center flex-wrap w-full gap-5 bg-gray-50 p-5 rounded-lg">
          ...
          <div className="flex justify-center items-center w-full gap-5">
            {/* Device Distribution Chart */}
            <div className="bg-white rounded-lg p-4 w-full">
              <h3 className="text-sm font-medium text-gray-600 mb-2">ISP</h3>
              <div className="h-[300px] flex justify-center items-center">
                <DoughnutChart
            ...
            {/* Device Distribution Chart */}
            <div className="bg-white rounded-lg p-4 w-full">
              <h3 className="text-sm font-medium text-gray-600 mb-2">Org</h3>
              <div className="h-[300px] flex justify-center items-center">
                <DoughnutChart
          ...
          <div className="flex justify-center items-center w-full gap-5">
            {/* Device Distribution Chart */}
            <div className="bg-white rounded-lg p-4 w-full">
              <h3 className="text-sm font-medium text-gray-600 mb-2">Proxy</h3>
              <div className="h-[300px] flex justify-center items-center">
                <DoughnutChart
